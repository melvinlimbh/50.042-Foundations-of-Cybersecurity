...
def hax():
    ...
    intended_message = b"Student ID 1005288 gets 4 points\n"

    changed_message = XOR(original_cipher,intended_message)
    plaintext = XOR(original_cipher,OTP)
    new_cipher = XOR(changed_message,plaintext)
    return new_cipher
